            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('dormitory', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>dormitory</Th>}
              ...
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    <Td>{record.checkin_date as unknown as string}</Td>
                    <Td>{record.days_to_stay}</Td>
                    ...
                    {hasAccess('dormitory', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/dormitories/view/${record.dormitory?.id}`}>
